...
Item {
    ...
    readonly property real _flightModeComboWidth:   ScreenTools.defaultFontPixelWidth * 16
    readonly property real _channelComboWidth:      ScreenTools.defaultFontPixelWidth * 16
