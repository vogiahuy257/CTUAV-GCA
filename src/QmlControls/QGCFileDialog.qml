...
Item {
    ...
    property var    nameFilters:    []  // Quan trọng: Chỉ các bộ lọc tên có ký tự đại diện đơn giản như *.foo mới được hỗ trợ.
            ...
            Column {
                ...
                Repeater {
                    ...
                    FileButton {
                        ...
                        onHamburgerClicked: {
                            controller.deleteFile(controller.fullyQualifiedFilename(folder, modelData))
                            fileRepeater.model = controller.getFiles(folder, [_rgExtensions])
                        }
                    }
