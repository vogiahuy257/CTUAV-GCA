        ...
        if (!line.startsWith("#")) {
            ...
            if (wpParams.size() == 5) {
                ...
                if (_parameterMgr->parameterExists(componentId, paramName)) {
                    ...
                    // Thay vì gán noVehicleValue = true; và vẫn append vào _diffList, ta bỏ qua hoàn toàn (continue;) khi param không tồn tại trên vehicle.
                    // Nếu parameter không tồn tại trên vehicle thì bỏ qua, không làm gì cả
                    continue;
                }
